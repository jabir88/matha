		...
		<div class="w3_agileits_contact_grids">
          ...
          @csrf
					<span class="input input--ichiro">
						<input class="input__field input__field--ichiro" type="text" id="input-25" name="Name" placeholder=" " value="{{old('Name')}}"/>
          ...
          @if ($errors->has('Name'))
              <span class="invalid-feedback" role="alert">
                <p style="color:red; font-size:15px; font-weight:700;">{{ $errors->first('Name') }}</p>
              </span>
          @endif
					<span class="input input--ichiro">
						<input class="input__field input__field--ichiro" type="email" id="input-26" name="Email" placeholder=" " value="{{old('Email')}}" />
          ...
          @if ($errors->has('Email'))
              <span class="invalid-feedback" role="alert">
                <p style="color:red; font-size:15px; font-weight:700;">{{ $errors->first('Email') }}</p>
              </span>
          @endif
					<textarea name="Message" placeholder="Your message here..." >{{old('Message')}}</textarea>
          @if ($errors->has('Message'))
              <span class="invalid-feedback" role="alert">
                <p style="color:red; font-size:15px; font-weight:700;">{{ $errors->first('Message') }}</p>
              </span>
          @endif
